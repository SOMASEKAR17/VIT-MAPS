...
export const SCALE_X = 2000 / GRID_HEIGHT; 
export const SCALE_Y = 3000 / GRID_HEIGHT; 
export const floorDimensions = {
  "gf-0001-ground-floor": { width: 2000, height: 3000 },
  "2f1d7148-15d2-459b-ac3b-df9605f94e1d": { width: 4202, height: 2970 },
